...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Jul 2019 pada 14.28
...
--
-- Database: `distro_threecolor`
--
CREATE DATABASE IF NOT EXISTS `distro_threecolor` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `distro_threecolor`;
...
INSERT INTO `kategori` (`id_kategori`, `kode_kategori`, `kategori`, `seo_kategori`) VALUES
(14, 'KC', 'Kaos Couple', 'kaos-couple');
...
CREATE TABLE `konfirmasi` (
  ...
  `id_user` int(5) NOT NULL,
  `rekening_transfer` int(1) NOT NULL,
...
(2, 4, 'Solo', 20000),
(3, 1, 'Bandung', 15000),
(4, 1, 'Tasikmalaya', 15000),
(5, 3, 'Surabaya', 25000),
(6, 4, 'Purwokerto', 20000),
(7, 4, 'Magelang', 20000),
(8, 3, 'Madiun', 25000);
...
CREATE TABLE `produk` (
  ...
  `seo_produk` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `produk` (`id_produk`, `kode_kategori`, `kode_produk`, `produk`, `stok`, `berat`, `harga`, `keterangan`, `gambar`, `seo_produk`) VALUES
(1, 'KC', '001', 'Kaos Pasangan Couple', 50, 100, 7500000, 'Bahan : Cotton', 'Kaos Couple.jpg', 'kaos-pasangan-couple');
...
INSERT INTO `user` (`id_user`, `username`, `password`, `nama`, `email`, `telp`, `alamat`) VALUES
(3, 'delma', '827ccb0eea8a706c4c34a16891f84e7b', 'delma', 'delmasaca123@gmail.com', '081317323737', 'jl raya caringin rt 01/06 cicurug-sukabumi'),
(4, 'aahya', '25d55ad283aa400af464c76d713c07ad', 'ahyamustopa', 'bioleader1001@gmail.com', '089652443420', 'asrama pusdikzi lawanggintung no.59');
...
--
ALTER TABLE `provinsi`
  MODIFY `id_provinsi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
(9, '2019_06_24_064206_create_homes_table', 1),
(10, '2019_06_24_081809_create_admins_table', 1);
...
--
-- Database: `kingofkings`
--
CREATE DATABASE IF NOT EXISTS `kingofkings` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `kingofkings`;
...
(3, '2019_03_27_015908_create_customers_table', 1),
(4, '2019_03_27_020138_create_products_table', 1),
(5, '2019_03_27_020226_create_invoices_table', 1),
(6, '2019_03_27_020301_create_invoice_details_table', 1);
...
('root', '[{\"db\":\"daengweb_invoice\",\"table\":\"karyawans\"},{\"db\":\"daengweb_invoice\",\"table\":\"customers\"},{\"db\":\"daengweb_invoice\",\"table\":\"products\"},{\"db\":\"daengweb_invoice\",\"table\":\"users\"},{\"db\":\"daengweb_invoice\",\"table\":\"migrations\"},{\"db\":\"daengweb_invoice\",\"table\":\"monics\"}]');
...
('root', '2019-07-05 12:27:38', '{\"lang\":\"id\",\"Console\\/Mode\":\"collapse\"}');
